...
func GetMultiAddr(enderecos []string, urlAPI string, multiAddr string) Model.MultiEndereco {
...
func GetEndereco(endereco string, urlAPI string, RawAddr string) Model.Endereco {
	fmt.Println("Calling API...")
	client := &http.Client{}
	req, err := http.NewRequest("GET", urlAPI+RawAddr+endereco, nil)
	if err != nil {
